    ...
    return (
        <div className="root">
            <div className="search">
                ...
                <Select style={{width:200,marginLeft:20}} placeholder="状态" onChange={handleStateChange} value={state}>
                    <Option value="all">all</Option>
                    <Option value="open">open</Option>
                    <Option value="closed">closed</Option>
                </Select>
                <Select style={{marginLeft:20,marginRight:20,flexGrow: 1}} placeholder="Label" onChange={handleLabelChange} value={label} mode="multiple">
                    {
